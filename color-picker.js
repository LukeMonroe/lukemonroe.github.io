...
class ColorPicker {
  ...
  updateDivColor(color) {
    ...
    this.divColor.appendChild(this.createDivColorText(`contrast: ${color.contrast}:1`))
  ...
  createDivColorFullscreen(color) {
    ...
    this.divColorFullscreen.appendChild(this.createDivColorText(`contrast: ${color.contrast}:1`))
